...
# Changes made     : added sink() to hide process output from design.alpha
# -------------------------------------------------------------------------------------
#' @name randomizeAlphaLattice
#' @aliases randomizeAlphaLattice
#  @aliases randomizeAlphaLattice.default
#' @title Randomization for Alpha Lattice design
#'
...
#'
#' @examples
#' randomizeAlphaLattice(numTrmt = 24, numFieldRow = 8, numFieldCol = 6, 
...
randomizeAlphaLattice <- function(numTrmt, numFieldRow, numFieldCol,
  ...
  #remove cols column and store it in object fieldbook
  fieldbook <- result$book[-2]
