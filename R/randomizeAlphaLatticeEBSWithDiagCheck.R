# -------------------------------------------------------------------------------------
# Name             : randomizeAlphaLatticeEBSWithDiagCheck
...
# -------------------------------------------------------------------------------------
#' @name randomizeAlphaLatticeEBSWithDiagCheck
#' @aliases randomizeAlphaLatticeEBSWithDiagCheck
#  @aliases randomizeAlphaLatticeEBSWithDiagCheck.default
#' @title Randomization for Alpha Lattice design using ebsRTools package with diagonal checks
#'
...
#'
#' @examples
#' randomizeAlphaLatticeEBSWithDiagCheck(numTrmt = 27, numSpatCheck = 1, 
...
randomizeAlphaLatticeEBSWithDiagCheck <- function(numTrmt, numSpatCheck, numFieldRow, numFieldCol,
  ...
  temptrmt[temptrmt == 0] <- as.numeric(as.vector(result[[1]]$book[(1+numTrmt):(nrow(result[[1]]$book)),"entry_id"]))
